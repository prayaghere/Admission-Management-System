...
import { getAdmins } from "@/services/headAdmin";
        ...
        <div>
          <div className="flex justify-between items-center mb-4 mt-10">
            ...
            <Button
              ...
              className="bg-primaryText text-white border-none focus:outline-none flex right-5 mt-2"
            >
              <span>
                <FaPlusCircle />
              </span>
              <span className="sm:ml-2"></span> Add Admin
            </Button>
          </div>
          <Separator className="mb-5" />
          {fetchingData ? ( // Render loader if fetching data
